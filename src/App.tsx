      ...
      <div className="py-12 px-6 pb-12 sm:px-40 bg-gradient-to-r from-[#E1DCD5] via-[#F2ECE4] bg-[#F2ECE4] w-full h-screen">
              ...
              >
                  ...
                  <div className="inline-flex gap-x-2">
                      ...
                      <div className="inline-flex gap-x-2">
                          ...
                          <img src={AlternativeToLogo}  alt="Alternative To Logo"/>
                      </div>
                  </div>
              </div>
          ...
          >
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
                  ...
                  <img src={ShopifyLogo}  alt="Netflix Logo"/>
                  <img src={SpotifyLogo}  alt="Netflix Logo"/>
                  <img src={WalmartLogo}  alt="Netflix Logo"/>
              </div>
          </div>
      </div>
  );
